<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Site3.Master" AutoEventWireup="true" CodeBehind="MainSpecialist.aspx.cs" Inherits="ServiceDesk.Views.WebForm6" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row" style="height:40vh">
        ...
        <div class="col d-flex justify-content-center">
                <asp:Calendar ID="Calendar1" runat="server" OnSelectionChanged="Calendar_SelectionChanged" Visible="false" BackColor="White" BorderColor="Black" 
                    DayNameFormat="Shortest" Font-Names="Times New Roman" Font-Size="10pt" ForeColor="Black" Height="100%" NextPrevFormat="FullMonth" 
                    TitleFormat="Month" Width="100%">
    ...
    <div class="row">
        <h3>Уведомления о горящих заявках</h3>
   ...
   <ajaxToolkit:ModalPopupExtender ID="ModalPopupExtender2" PopupControlID="Panel2" runat="server" 
    ...
    <ajaxToolkit:ModalPopupExtender ID="ModalPopupExtender6" PopupControlID="Panel6" runat="server" 
     ...
     <asp:Panel ID="Panel6" CssClass="modalPopup2" runat="server">
         ...
         <div id ="footer6"></div>
         <asp:Button ID="Button11" runat="server" Text="Изменить" OnClick="Button4_Click" CssClass="btn-group"/>
